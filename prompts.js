...
export const PROMPTS = [
  ...
  { q: "Name another English word for a nose (any creature's counts)", cat: "words",
  ...
  { q: "Name a word for a baby animal", cat: "words",
  ...
  { q: "Name a collective noun for a group of animals (like 'murder' for crows)", cat: "words",
  ...
  { q: "Name a palindrome that's a real English dictionary word", cat: "words",
  ...
  { q: "Name a word for a huge number (million or bigger)", cat: "words",
  ...
  { q: "Name a type of building used for prayer", cat: "culture",
  ...
  { q: "Name an occupation that involves working with children (the job itself must focus on kids)", cat: "culture",
  ...
  { q: "Name a household chore", cat: "culture",
  ...
  { q: "Name something you drink out of", cat: "culture",
  ...
  { q: "Name a type of home or dwelling", cat: "culture",
  ...
  { q: "Name a tool you would find in a toolbox", cat: "culture",
  ...
  { q: "Name an animal that produces its own light", cat: "sci",
  ...
  { q: "Name a mammal that lives underground", cat: "sci",
  ...
  { q: "Name an animal that hibernates", cat: "sci",
  ...
  { q: "Name an animal known for camouflage", cat: "sci",
  ...
  { q: "Name a creature you might find in a tide pool", cat: "sci",
  ...
  { q: "Name a living bird that cannot fly", cat: "sci",
  ...
  { q: "Name a country that borders India by land or sea", cat: "geo",
  ...
  { q: "Name a country whose national flag has exactly two colors", cat: "geo",
  ...
  { q: "Name a country with a four-letter English name", cat: "geo",
  ...
  { q: "Name a strait (a narrow sea passage between two landmasses)", cat: "geo",
  ...
  { q: "Name a country that no longer exists", cat: "geo",
  ...
  { q: "Name a chemical element that is a gas at room temperature", cat: "sci",
  ...
  { q: "Name a gas found in Earth's atmosphere", cat: "sci",
  ...
  { q: "Name a part of the human brain", cat: "health",
  ...
  { q: "Name a part of the human eye", cat: "health",
  ...
  { q: "Name a human hormone", cat: "health",
  ...
  { q: "Name a subatomic particle", cat: "sci",
  ...
  { q: "Name a state of matter", cat: "sci",
  ...
  { q: "Name a Pixar protagonist (co-leads count)", cat: "culture",
  ...
  { q: "Name a literary device", cat: "words",
  ...
  { q: "Name a logical fallacy", cat: "words",
  ...
  { q: "Name a type of graph or chart", cat: "sci",
  ...
  { q: "Name a metric (SI) prefix", cat: "sci",
  ...
  { q: "Name a type of energy", cat: "sci",
  ...
  { q: "Name a branch of science ending in -ology", cat: "sci",
  ...
  { q: "Name a phobia (its formal name, like 'arachnophobia')", cat: "words",
  ...
  { q: "Name a type of knot", cat: "culture",
  ...
  { q: "Name a street suffix (like Street or Avenue)", cat: "culture",
  ...
  { q: "Name a geologic eon, era, period, or epoch", cat: "sci",
  ...
  { q: "Name a type of paper", cat: "culture",
  ...
  { q: "Name a piece of armor", cat: "hist",
  ...
  { q: "Name a cryptid (a creature like Bigfoot whose existence is claimed but unproven)", cat: "myth",
  ...
  { q: "Name a Roman god or goddess", cat: "myth",
